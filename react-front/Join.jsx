...
function Join(props) {
    ...
    return (
        <div className="join_box" style={centerStyle}>
            <Title />
            <form action={props.routes.join} method="post" style={inputStyle}>
                <input type="text" name="username" required={true} style={instyle} placeholder="닉네임" />
                <input type="text" name="email" required={true} style={instyle} placeholder="이메일" />
                <input type="password" name="password" required={true} style={instyle} placeholder="비밀번호" />
                <input type="password" name="password2" required={true} style={instyle} placeholder="비밀번호 확인" />
                <input type="submit" value="가입하기" style={instyle} />
            </form>
            <div style={astate}>
